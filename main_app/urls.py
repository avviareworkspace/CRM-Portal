...
urlpatterns = [
    ...
    path("leads/import/failures/", admin_views.import_lead_failures, name='import_lead_failures'),
    path("leads/import/failures/download/", admin_views.download_import_failures_excel, name='download_import_failures_excel'),
